...
void CreateCube(HEMesh& mesh)
{
	...
	mesh.add_face(vhandles[0], vhandles[3], vhandles[7], vhandles[4]);
	mesh.add_face(vhandles[2], vhandles[1], vhandles[5], vhandles[6]);
	mesh.add_face(vhandles[1], vhandles[0], vhandles[4], vhandles[5]);
	mesh.add_face(vhandles[3], vhandles[2], vhandles[6], vhandles[7]);	
